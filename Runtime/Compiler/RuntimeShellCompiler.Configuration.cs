...
public sealed partial class RuntimeShellCompiler
{
    ...
    public RuntimeShellCompiler WatchDirectory(string path)
    {
    ...
    /// <returns>This compiler for fluent configuration chaining.</returns>
    public RuntimeShellCompiler AddReference(Assembly assembly)
    {
    ...
    /// <returns>This compiler for fluent configuration chaining.</returns>
    public RuntimeShellCompiler AddReference(MetadataReference reference)
    {
