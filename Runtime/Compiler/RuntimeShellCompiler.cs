...
/// <list>
///   <item><description><c>RuntimeShellCompiler.cs</c> core fields, constructor, and event.</description></item>
///   <item><description><c>RuntimeShellCompiler.Configuration.cs</c> <see cref="WatchDirectory"/> and <c>AddReference</c> methods.</description></item>
///   <item><description><c>RuntimeShellCompiler.Compilation.cs</c> Roslyn compilation and <see cref="IEditorShellBuilder"/> discovery.</description></item>
///   <item><description><c>RuntimeShellCompiler.FileWatcher.cs</c> <see cref="FileSystemWatcher"/> event handlers with debounce timer.</description></item>
///   <item><description><c>RuntimeShellCompiler.Lifecycle.cs</c> <see cref="Start"/>, <see cref="Recompile"/>, and <see cref="Dispose"/>.</description></item>
///   <item><description><c>RuntimeShellCompiler.LoadContext.cs</c> isolated <see cref="AssemblyLoadContext"/> and default reference setup.</description></item>
/// </list>
/// </para>
/// <para>
...
public sealed partial class RuntimeShellCompiler : IDisposable
{
    ...
    /// <summary>Creates a new <see cref="RuntimeShellCompiler"/> targeting the specified registry.</summary>
